(function(){
  ...
  /* ---------- GrowthRaja AI chat widget (every page) ---------- */
  ...
  if(chatToggle && chatPanel){
    ...
    var CANNED = [
      {
        ...
        reply: "We run Bronze, Silver and Gold tiers for Meta and Google Ads (\u20B910L, \u20B915L and \u20B930L monthly ad spend), plus WhatsApp API, SEO and AI Video packages. Check the \"Our Plans\" section for the full breakdown."
      },
      {
        keys: ['minimum', 'min spend', 'how much', 'budget', 'start with'],
        reply: "Our Meta and Google Ads packages start at \u20B910,00,000/month on Bronze and scale to \u20B930,00,000/month on Gold. If your budget is smaller, our SEO or AI Video packages are a good place to start."
      },
      {
      ...
      },
      {
        ...
        reply: "We're GrowthRaja \u2014 we build brands with quality leads, SEO, WhatsApp API, influencer marketing, AI videos, graphic design and website development, all under one roof."
      },
      {
      ...
      {
        keys: ['hi', 'hello', 'hey'],
        reply: "Hey! I'm the GrowthRaja AI. Ask me about our packages, pricing, or services \u2014 or tap Telegram below to reach the team directly."
      }
    ];
    ...
    function openChat(){
      ...
      if(!greeted){
        greeted = true;
        setTimeout(function(){
          addMessage("Welcome to GrowthRaja! I'm here to answer quick questions about our packages, pricing and services. For anything detailed, I'll point you to our team on Telegram.", 'bot');
        }, 300);
      }
    }
    function closeChat(){
